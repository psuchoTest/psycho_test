...
function check_answers(){
    ...
    main_text.innerText = 'Рекомендуем вам обратиться в эти учреждения :ГБУЗ ПК «Краевая клиническая психиатрическая больница» Больничный городок:614037, г. Пермь, ул. Корсуньская 2-я, д.10; Приемное отделение:main_text.innerHTML = '<a href=''tel: 8 (342) 263-95-84'> 8 (342) 263-95-84</a>"'; ';
